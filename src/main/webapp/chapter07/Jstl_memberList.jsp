...
<title>JSTL MemberList</title>
</head>
<body>
	<%-- for(Porduct bean : porductlist ){}
	<c:forEach var="bean" items="${porductlist }"> 
	</c:forEach> --%>
	...
	<center>
		...
		//EL 자체가 일반변수는 받을 수 없음 => requset영역에 저장하고 사용
		...
		for(int i=0;i<v.size(); i++){
			MemberDBBean bean=v.get(i); // 박스에서 가방 하나를 꺼내서 화면에 출력하기 위함
